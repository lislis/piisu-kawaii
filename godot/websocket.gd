...
export var controller_x = 0.0;
export var controller_y = 0.0;
export var controller_z = 0.0;
...
func _on_data():
	...
	if data.error == OK:
		controller_x = data.result["x"]
		controller_y = data.result["y"]
		controller_z = data.result["z"]
